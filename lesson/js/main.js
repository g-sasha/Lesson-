...
class AppData {
    ...
    // бюджет на день 
    getBudget(){
        this.percenDeposit = depositPercent.value;
        const monthDeposit = this.moneyDeposit * (this.percenDeposit / 100);
    ...
    depositPerc(){        
        depositPercent.addEventListener('input', e => {
            ...
            if(+target.value < 0 || +target.value > 100 || !isNumber(+target.value)){
